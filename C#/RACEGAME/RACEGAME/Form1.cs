...
namespace RACEGAME
{
    public partial class Form1 : Form
    {
        ...
        private void tmrGameTicks_Tick(object sender, EventArgs e)
        {
            ...
            label1.Text = "Angle: " + Convert.ToString(angleDegrees);
            label2.Text = "Force: " + Convert.ToString(force);
        ...
        Image GetImage()
        {
            ...
            Image image = Image.FromFile(@"C:\Users\Peter\Documents\School\Periode 1\RACEGAME\DRAAIEN\WindowsFormsApplication2\WindowsFormsApplication2\Miara.png");
